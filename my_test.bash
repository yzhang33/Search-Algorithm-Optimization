...
#
# NOTE: The old version of run_test.bash is incompatible with the new version of
# racetrack.py. You'll either need to use this new version, or change the old one
# as described below.
#
